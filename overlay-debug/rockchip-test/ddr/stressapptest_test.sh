...
echo "*************************** DDR STRESSAPPTEST TEST 0.5H ***************************************"
echo "**run: stressapptest -s 1800 -i 4 -C 4 -W --stop_on_errors -M $mem_test_size -l $RESULT_LOG**"

stressapptest -s 1800 -i 4 -C 4 -W --stop_on_errors -M $mem_test_size -l $RESULT_LOG &
